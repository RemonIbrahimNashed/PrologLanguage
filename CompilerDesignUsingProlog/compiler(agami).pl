...
switch_case_stmt -->skip,switch_keyword,skip,switch_case_condition,skip,open_curlybracket,skip,case_stmts,skip,(default_stmt|[]),skip,close_curlybracket,skip.
break_stmt -->skip,break_keyword,skip,semicolon_op.
default_stmt -->skip,default_keyword,skip,double_douts,skip,stmts.
case_stmt -->skip,case_keyword,skip,digit,skip,double_douts,skip,stmts,skip,break_stmt.
case_stmts -->skip ,case_stmt , skip ,case_stmt,skip | [] .
